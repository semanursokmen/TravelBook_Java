...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db= Room.databaseBuilder(getApplicationContext(),PlaceDatabase.class, "Places")
                //.allowMainThreadQueries() tavsiye edilmiyor.
                .build();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (intentInfo.equals("new")) {
            ...
            //konumla ilgili işlemlerde LocationManager ve LocationListener 'a ihtiyaç duyulur.
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                //direkt konuma yönlendiriyor takılmadan.
    ...
    public void save (View view) {
        ...
        //threading -> main UI(main thread) kullanıcı arayüzü işlemleri yapıyoruz.
